...
def cms_decommissioner(rse: dict[str, Any], config: dict[str, Any]) -> DecommissioningProfile:
    ...
    The "CMS move" profile lists out all rules that are locking replicas
    at the given RSE, and moves them to the specified destination if either
    one of the following is true:

    - TODO: add cms move additions
    ...
    return DecommissioningProfile(
        ...
        handlers = [
            ...
            # Every other rule should be processed.
            (_has_replicas_on_rse, move_to_destination)
        ],
        
        # TODO: where to include update from jason and add moc protocols ? is it important?
        # TODO: should we just delete the rse?
